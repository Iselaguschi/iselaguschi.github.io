...
(function () {
   ...
   * getAccountData() first checks if the weather data is in the cache. If so,
   * then it gets that data and populates the card with the cached data.
   * Then, getAccountData() goes to the network for fresh data. If the network
   ...
   */
    ...
    app.updateForecasts = function () {
        ...
        keys.forEach(function (key) {
            app.getAccountData(key);
        });
    };

    // Save list of cities to localStorage.
    app.saveSelectedAccounts = function () {
        var selectedCities = JSON.stringify(app.selectedAccounts);
   ...
   */
    ...
    if (app.selectedAccounts) {
        ...
        app.selectedAccounts.forEach(function (city) {
            app.getAccountData(city.key, city.label);
        });
    } else {
